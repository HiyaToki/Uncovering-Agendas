...
en_bert_agenda_test_file = base_dir + "evaluation/agenda_rte_en_bert_test.json"
bi_mbert_agenda_test_file = base_dir + "evaluation/agenda_rte_bi_mbert_test.json"

mbert_agenda_test_file = base_dir + "evaluation/agenda_mbert_test.json"
bert_agenda_test_file = base_dir + "evaluation/agenda_bert_test.json"

en_bert_rte_agenda_test_file = base_dir + "evaluation/rte_en_bert_test.json"
bi_mbert_rte_agenda_test_file = base_dir + "evaluation/rte_bi_mbert_test.json"

# output file paths for dev files
en_bert_agenda_dev_file = base_dir + "evaluation/agenda_rte_en_bert_dev.json"
bi_mbert_agenda_dev_file = base_dir + "evaluation/agenda_rte_bi_mbert_dev.json"

mbert_agenda_dev_file = base_dir + "evaluation/agenda_mbert_dev.json"
bert_agenda_dev_file = base_dir + "evaluation/agenda_bert_dev.json"

en_bert_rte_agenda_dev_file = base_dir + "evaluation/rte_en_bert_dev.json"
bi_mbert_rte_agenda_dev_file = base_dir + "evaluation/rte_bi_mbert_dev.json"

# trained models file paths
en_bert_file_path = base_dir + "models/AGENDA-RTE-EN-BERT/"
bi_mbert_file_path = base_dir + "models/AGENDA-RTE-BI-MBERT/"

mbert_file_path = base_dir + "models/AGENDA-MBERT/"
bert_file_path = base_dir + "models/AGENDA-BERT/"

en_bert_rte_file_path = base_dir + "models/RTE-EN-BERT/"
bi_mbert_rte_file_path = base_dir + "models/RTE-BI-MBERT/"

# switcher
model_choice = "rte_en_bert"
