...
bert_agenda_test_file = base_dir + "evaluation/mlc_agenda_bert_test.json"
mbert_agenda_test_file = base_dir + "evaluation/mlc_agenda_mbert_test.json"

# output file paths for dev file
bert_agenda_dev_file = base_dir + "evaluation/mlc_agenda_bert_dev.json"
mbert_agenda_dev_file = base_dir + "evaluation/mlc_agenda_mbert_dev.json"

# trained models file paths
bert_file_path = base_dir + "models/MLC-AGENDA-BERT/"
mbert_file_path = base_dir + "models/MLC-AGENDA-MBERT/"
