...
sbert_hypotheses_agenda_test_file = base_dir + "evaluation/ss_sbert_hypotheses_test.json"
sbert_labels_agenda_test_file = base_dir + "evaluation/ss_sbert_labels_test.json"

msbert_hypotheses_agenda_test_file = base_dir + "evaluation/ss_msbert_hypotheses_test.json"
msbert_labels_agenda_test_file = base_dir + "evaluation/ss_msbert_labels_test.json"

# output file paths for dev set
sbert_hypotheses_agenda_dev_file = base_dir + "evaluation/ss_sbert_hypotheses_dev.json"
sbert_labels_agenda_dev_file = base_dir + "evaluation/ss_sbert_labels_dev.json"

msbert_hypotheses_agenda_dev_file = base_dir + "evaluation/ss_msbert_hypotheses_dev.json"
msbert_labels_agenda_dev_file = base_dir + "evaluation/ss_msbert_labels_dev.json"
